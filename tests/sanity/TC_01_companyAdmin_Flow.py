...
def before_each(page):
    ...
    action_factory.login_actions.select_organization("Company Admin")
...
def test_company_admin_flow_test(before_each):
    ...
    try: 
        ...
        dataset_name = action_factory.helpers.fetch_dotenv("sanity_Dataset_Name")
        template_name = action_factory.helpers.fetch_dotenv("sanity_Template_Name")
        workflow_name = action_factory.helpers.fetch_dotenv("sanity_Workflow_Name")
        ...
        if template_name in template_applied:
            ...
            assert False, message
        action_factory.ui_utils.smart_wait()
        action_factory.workflows_actions.nodes_connection_flow(node_Name1="review", position1="right", index1=2,
                                                             node_Name2="annotate", position2="left", index2=1)
        action_factory.ui_utils.smart_wait()
