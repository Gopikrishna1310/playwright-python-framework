...
@allure.story("TC_04: Start -> Annotate 1 -> Annotate 2 -> Review -> Complete Same Template (Delete Linked)")
@allure.title("Verify attempting to delete a TC_04 workflow linked to an active project is blocked")
def test_tc04_delete_wf_start_ann1_ann2_rev_complete_same(before_each):
    status = "Fail"
    message = ""
    try:
