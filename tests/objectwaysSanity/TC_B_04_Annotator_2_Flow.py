...
def before_each(page):
    ...
    email = action_factory.helpers.fetch_dotenv("annotator_Username_2")
    password = action_factory.helpers.fetch_dotenv("annotator_Password_2")
...
@allure.feature("Annotator 2")
@allure.story("Annotator 2 Flow")
@allure.title("Annotator 2 Flow Validation")
def test_Annotator_Flow_test(before_each):
    status = "Fail"
    message = ""
    try: 
        action_factory = before_each
        annotator_email = action_factory.helpers.fetch_dotenv("annotator_Username_2")
        ...
        if is_visible:
            ...
            assert False, message
        action_factory.ui_utils.smart_wait()
        # Checking First Annotation and Reviewer is there or not
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_B_reviewer_1_text_Approve in transcription and TC_B_reviewer_1_text_Edit in transcription and TC_B_annotation_1_1 in transcription and TC_B_annotation_1_Edit in transcription
        Transcription_do_not_have = TC_B_annotation_1_2 not in transcription and TC_B_annotation_1_3 not in transcription and TC_B_annotation_1_4 not in transcription
        ...
        action_factory.annotator_actions.annontate_files(TC_B_annotation_2_1, fast_forward = "25")
        action_factory.annotator_actions.annontate_files(TC_B_annotation_2_2)
        action_factory.annotator_actions.annontate_files(TC_B_annotation_2_3)
        action_factory.annotator_actions.annontate_files(TC_B_annotation_2_4)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_B_annotation_2_1 in transcription and TC_B_annotation_2_2 in transcription and TC_B_annotation_2_3 in transcription and TC_B_annotation_2_4 in transcription
        if Transcription_to_have:
            status = "Pass"
            message = f"Transcription text matches the input text."
            action_factory.helpers.attach_screenshot(name="TranscriptionMatches")
            action_factory.helpers.attach_allure(name="Transcription", text="\n".join(transcription))
        ...
        action_factory.annotator_actions.perform_edit_transcription(old_transcription = TC_B_annotation_2_4, new_transcription=TC_B_annotation_2_Edit)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_B_annotation_2_Edit in transcription and TC_B_annotation_2_4 not in transcription:
            status = "Pass"
        ...
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_B_annotation_2_1 in transcription and TC_B_annotation_2_2 in transcription and TC_B_annotation_2_3 in transcription and TC_B_annotation_2_4 not in transcription and TC_B_annotation_2_Edit in transcription:
            status = "Pass"
        ...
        action_factory.annotator_actions.perform_delete_transcription(TC_B_annotation_2_3)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_B_annotation_2_3 not in transcription:
            status = "Pass"
        ...
        Transcription_to_have = TC_B_annotation_1_1 in transcription and TC_B_annotation_1_Edit in transcription and TC_B_reviewer_1_text_Edit in transcription and TC_B_reviewer_1_text_Approve in transcription and TC_B_annotation_2_1 in transcription and TC_B_annotation_2_Edit in transcription and TC_B_annotation_2_2 in transcription
        Transcription_do_not_have = TC_B_annotation_1_2 not in transcription and TC_B_annotation_1_3 not in transcription and TC_B_annotation_1_4 not in transcription and TC_B_annotation_2_3 not in transcription and TC_B_annotation_2_4 not in transcription
        if Transcription_to_have and Transcription_do_not_have:
            status = "Pass"
            message = f"Transcription text matches the input text."
        ...
        action_factory.annotator_actions.annontate_files(TC_B_annotation_2_4)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        found_annotations = [ann for ann in [TC_B_annotation_2_1, TC_B_annotation_2_2, TC_B_annotation_2_3, TC_B_annotation_2_4] if ann in transcription]
