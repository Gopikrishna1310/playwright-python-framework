...
def test_Annotator_Flow_C_test(before_each):
    ...
    try: 
        ...
        if is_visible:
            ...
            assert False, message
        action_factory.ui_utils.smart_wait()
        action_factory.annotator_actions.annontate_files(TC_C_annotation_2_1, fast_forward = "25")
        action_factory.annotator_actions.annontate_files(TC_C_annotation_2_2)
        action_factory.annotator_actions.annontate_files(TC_C_annotation_2_3)
        action_factory.annotator_actions.annontate_files(TC_C_annotation_2_4)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_2_1 in transcription and TC_C_annotation_2_2 in transcription and TC_C_annotation_2_3 in transcription and TC_C_annotation_2_4 in transcription:
            status = "Pass"
        ...
        action_factory.annotator_actions.perform_edit_transcription(old_transcription = TC_C_annotation_2_4, new_transcription=TC_C_annotation_2_Edit)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_2_Edit in transcription and TC_C_annotation_2_4 not in transcription:
            status = "Pass"
        ...
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_C_annotation_2_1 in transcription and TC_C_annotation_2_2 in transcription and TC_C_annotation_2_3 in transcription and TC_C_annotation_2_Edit in transcription
        Transcription_do_not_have = TC_C_annotation_2_4 in transcription
        ...
        action_factory.annotator_actions.perform_delete_transcription(TC_C_annotation_2_3)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_2_3 not in transcription:
            status = "Pass"
