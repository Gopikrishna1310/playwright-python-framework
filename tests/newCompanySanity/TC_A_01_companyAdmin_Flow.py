...
def test_company_admin_flow_test(before_each):
    status = "Fail"
    message = ""
    try: 
        action_factory = before_each
        
        dataset_name = test_data_inputs.TC_A_dataset_name
        template_name = test_data_inputs.TC_A_template_name
        workflow_name = test_data_inputs.TC_A_workflow_name
        project_name = test_data_inputs.TC_A_project_name
        ...
        nodes_list = test_data_inputs.TC_A_nodes_list
        ...
        i = action_factory.helpers.resolve_next_index(dataset_names_list, test_data_inputs.TC_A_dataset_name)

        dataset_name = test_data_inputs.TC_A_dataset_name.format(i=i) if "{i}" in test_data_inputs.TC_A_dataset_name else test_data_inputs.TC_A_dataset_name
        template_name = test_data_inputs.TC_A_template_name.format(i=i) if "{i}" in test_data_inputs.TC_A_template_name else test_data_inputs.TC_A_template_name
        workflow_name = test_data_inputs.TC_A_workflow_name.format(i=i) if "{i}" in test_data_inputs.TC_A_workflow_name else test_data_inputs.TC_A_workflow_name
