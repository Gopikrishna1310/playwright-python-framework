...
def test_Reviewer_Flow_2_test(before_each):
    status = "Fail"
    message = ""
    try: 
        ...
        Transcription_to_have = TC_D_annotation_1_1 in transcription and TC_D_annotation_1_Edit in transcription and TC_D_reviewer_1_text_Edit in transcription and TC_D_reviewer_1_text_Approve in transcription
        Transcription_do_not_have = TC_D_annotation_1_2 not in transcription and TC_D_annotation_1_3 not in transcription and TC_D_annotation_1_4 not in transcription
        ...
        action_factory.annotator_actions.annontate_files(TC_D_reviewer_2_text_Approve, fast_forward = "25")
        # Validate Reviewer Annotation
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_D_reviewer_2_text_Approve in transcription:
            status = "Pass"
            message = f"Transcription text matches the input text."
            action_factory.helpers.attach_screenshot(name="TranscriptionMatches")
            action_factory.helpers.attach_allure(name="Transcription", text="\n".join(transcription))
        ...
        if TC_D_reviewer_2_text_Approve in reviewer_transcription:
            status = "Pass"
        ...
        action_factory.annotator_actions.perform_edit_transcription(TC_D_annotation_1_2, TC_D_reviewer_2_text_Edit)
        # Validate Reviewer Transcription after edit
        reviewer_transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_D_reviewer_2_text_Edit in reviewer_transcription and TC_D_annotation_1_2 not in reviewer_transcription:
            status = "Pass"
