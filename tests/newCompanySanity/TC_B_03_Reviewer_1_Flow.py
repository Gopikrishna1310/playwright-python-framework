...
def test_Reviewer_Flow_test(before_each):
    ...
    try: 
        ...
        action_factory.annotator_actions.annontate_files(TC_B_reviewer_1_text_Approve, fast_forward = "15")
        # Validate Reviewer Annotation
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_B_reviewer_1_text_Approve in transcription:
            status = "Pass"
            message = f"Transcription text matches the input text."
            action_factory.helpers.attach_screenshot(name="TranscriptionMatches")
            action_factory.helpers.attach_allure(name="Transcription", text="\n".join(transcription))
        ...
        if TC_B_reviewer_1_text_Approve in reviewer_transcription:
            status = "Pass"
        ...
        action_factory.annotator_actions.perform_edit_transcription(TC_B_annotation_1_2, TC_B_reviewer_1_text_Edit)
        # Validate Reviewer Transcription after edit
        reviewer_transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_B_reviewer_1_text_Approve in reviewer_transcription and TC_B_reviewer_1_text_Edit in reviewer_transcription and TC_B_annotation_1_1 in reviewer_transcription and TC_B_annotation_1_Edit in reviewer_transcription
        Transcription_do_not_have = TC_B_annotation_1_2 not in reviewer_transcription and TC_B_annotation_1_3 not in reviewer_transcription and TC_B_annotation_1_4 not in reviewer_transcription
        if Transcription_to_have and Transcription_do_not_have:
            status = "Pass"
