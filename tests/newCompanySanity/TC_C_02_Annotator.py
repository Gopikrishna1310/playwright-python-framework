...
def test_Annotator_Flow_C_test(before_each):
    ...
    try: 
        ...
        if is_visible:
            ...
            assert False, message
        action_factory.ui_utils.smart_wait()
        action_factory.annotator_actions.annontate_files(TC_C_annotation_1_1)
        action_factory.annotator_actions.annontate_files(TC_C_annotation_1_2)
        action_factory.annotator_actions.annontate_files(TC_C_annotation_1_3)
        action_factory.annotator_actions.annontate_files(TC_C_annotation_1_4)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        found_annotations = [ann for ann in [TC_C_annotation_1_1, TC_C_annotation_1_2, TC_C_annotation_1_3, TC_C_annotation_1_4] if ann in transcription]
        ...
        if len(found_annotations) == 4:
            ...
            action_factory.helpers.attach_allure(name="Annotation", text=TC_C_annotation_1_1)
        ...
        action_factory.annotator_actions.perform_edit_transcription(old_transcription = TC_C_annotation_1_4, new_transcription=TC_C_annotation_1_Edit)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_1_Edit in transcription and TC_C_annotation_1_4 not in transcription:
            status = "Pass"
        ...
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_1_1 in transcription and TC_C_annotation_1_2 in transcription and TC_C_annotation_1_3 in transcription and TC_C_annotation_1_4 not in transcription and TC_C_annotation_1_Edit in transcription:
            status = "Pass"
        ...
        action_factory.annotator_actions.perform_delete_transcription(TC_C_annotation_1_3)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_1_3 not in transcription:
            status = "Pass"
        ...
        action_factory.ui_utils.element_wait_for(action_factory.page_factory.annotator_page.transcription.nth(0),timeout=30000)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_annotation_1_1 in transcription and TC_C_annotation_1_2 in transcription and  TC_C_annotation_1_3 not in transcription and TC_C_annotation_1_4 not in transcription and TC_C_annotation_1_Edit in transcription:
            status = "Pass"
