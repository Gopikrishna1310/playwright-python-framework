...
def test_Validate_File_status_test(before_each):
    ...
    try: 
        ...
        Dataset_files = [("audio 2.flac","Complete"),("audio 3.mp3","Complete")]
        ...
        expected_texts = [TC_D_annotation_1_1, TC_D_annotation_1_Edit, TC_D_reviewer_1_text_Approve,TC_D_reviewer_1_text_Edit,TC_D_reviewer_2_text_Approve,TC_D_reviewer_2_text_Edit]
        unexpected_texts = [TC_D_annotation_1_2,TC_D_annotation_1_3, TC_D_annotation_1_4]
        ...
        if file_transcriptions:
            status = "Pass"
            message = f"Exported JSON file contains Annotator transcription ('{TC_D_annotation_1_1}','{TC_D_annotation_1_Edit}','{TC_D_reviewer_1_text_Approve}','{TC_D_reviewer_1_text_Edit}') and Reviewer transcription ('{TC_D_reviewer_2_text_Approve}','{TC_D_reviewer_2_text_Edit}') for files {Dataset_files_upload}."
            ...
            status = "Fail"
            message = f"Exported JSON file validation failed. Annotator text in JSON: {TC_D_annotation_1_1 in file_transcriptions}, Reviewer text in JSON: {TC_D_reviewer_1_text_Approve in file_transcriptions}."
