...
def test_Reviewer_Flow_test(before_each):
    ...
    try: 
        ...
        action_factory.reviewer_actions.is_annotation_present("Annotator 2")
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_C_annotation_2_1 in transcription and TC_C_annotation_2_2 in transcription and TC_C_annotation_2_Edit in transcription
        Transcription_do_not_have = TC_C_annotation_2_3 in transcription and TC_C_annotation_2_4 in transcription
        if Transcription_to_have and not Transcription_do_not_have:
            status = "Pass"
            message = f"Annotator 2 : Transcription text matches the input text."
            action_factory.helpers.attach_screenshot(name="Annotator2TranscriptionMatches")
            action_factory.helpers.attach_allure(name="Annotator2 Transcription", text="\n".join(transcription))
            assert True, message
        else:
            status = "Fail"
            message = f"Annotator 2 : Transcription text does not match the input text."
            action_factory.helpers.attach_screenshot(name="Annotator2TranscriptionNotMatches")
            action_factory.helpers.attach_allure(name="Annotator2 Transcription", text="\n".join(transcription))
            assert False, message
        
        action_factory.reviewer_actions.is_annotation_present("Annotator 1")
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_C_annotation_1_1 in transcription and TC_C_annotation_1_2 in transcription and TC_C_annotation_1_Edit in transcription
        Transcription_do_not_have = TC_C_annotation_1_3 in transcription and TC_C_annotation_1_4 in transcription
        if Transcription_to_have and not Transcription_do_not_have:
            status = "Pass"
            message = f"Annotator 1 : Transcription text matches the input text."
            action_factory.helpers.attach_screenshot(name="Annotator1TranscriptionMatches")
            action_factory.helpers.attach_allure(name="Annotator1 Transcription", text="\n".join(transcription))
            assert True, message
        else:
            status = "Fail"
            message = f"Annotator 1 : Transcription text does not match the input text."
            action_factory.helpers.attach_screenshot(name="Annotator1TranscriptionNotMatches")
            action_factory.helpers.attach_allure(name="Annotator1 Transcription", text="\n".join(transcription))
            assert False, message

        action_factory.annotator_actions.annontate_files(TC_C_reviewer_1_text_Approve, fast_forward = "40")
        # Validate Reviewer Annotation
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        if TC_C_reviewer_1_text_Approve in transcription:
            status = "Pass"
        ...
        if TC_C_reviewer_1_text_Approve in reviewer_transcription:
            status = "Pass"
        ...
        action_factory.annotator_actions.perform_edit_transcription(TC_C_annotation_1_2, TC_C_reviewer_1_text_Edit)
        # Validate Reviewer Transcription after edit
        reviewer_transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_C_annotation_1_1 in transcription and TC_C_annotation_1_Edit in transcription and TC_C_reviewer_1_text_Edit in reviewer_transcription and TC_C_reviewer_1_text_Approve in reviewer_transcription
        Transcription_do_not_have = TC_C_annotation_1_2 in reviewer_transcription and  TC_C_annotation_1_3 in reviewer_transcription and TC_C_annotation_1_4 in reviewer_transcription
        if Transcription_to_have and not Transcription_do_not_have:
            status = "Pass"
        ...
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        Transcription_to_have = TC_C_annotation_1_1 in transcription and TC_C_reviewer_1_text_Edit in transcription and TC_C_annotation_1_Edit in transcription and TC_C_reviewer_1_text_Approve in transcription
        Transcription_do_not_have = TC_C_annotation_1_2 in transcription and  TC_C_annotation_1_3 in transcription and TC_C_annotation_1_4 in transcription
        if Transcription_to_have and not Transcription_do_not_have:
            status = "Pass"
        ...
        action_factory.ui_utils.element_wait_for(action_factory.page_factory.annotator_page.transcription.nth(0),timeout=30000)
        transcription = action_factory.ui_utils.grab_text_from_all(action_factory.page_factory.annotator_page.transcription)
        TTranscription_to_have = TC_C_annotation_1_1 in transcription and TC_C_reviewer_1_text_Edit in transcription and TC_C_annotation_1_Edit in transcription and TC_C_reviewer_1_text_Approve in transcription
        Transcription_do_not_have = TC_C_annotation_1_2 in transcription and  TC_C_annotation_1_3 in transcription and TC_C_annotation_1_4 in transcription
        if Transcription_to_have and not Transcription_do_not_have:
            status = "Pass"
            message = f"Auto-save - transcription saved successfully."
