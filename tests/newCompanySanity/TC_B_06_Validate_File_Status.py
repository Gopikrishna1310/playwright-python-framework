...
def test_Validate_File_status_test(before_each):
    ...
    try: 
        ...
        Dataset_files = [("audio 2.flac","Complete"),("audio 3.mp3","Rejected")]
        ...
        i = action_factory.helpers.resolve_latest_index(project_name_list, test_data_inputs.TC_B_project_name)
        ...
        action_factory.ui_utils.smart_wait()
        for file_Name, expected_status in Dataset_files:
            action_factory.ui_utils.smart_wait()
        ...
        expected_texts = [TC_B_annotation_1_1, TC_B_annotation_1_Edit, TC_B_annotation_2_1,TC_B_annotation_2_Edit,TC_B_reviewer_1_text_Approve,TC_B_reviewer_1_text_Edit,TC_B_reviewer_2_text_Approve,TC_B_reviewer_2_text_Edit]
        unexpected_texts = [TC_B_annotation_1_2,TC_B_annotation_1_3, TC_B_annotation_1_4, TC_B_annotation_2_2, TC_B_annotation_2_3, TC_B_annotation_2_4]
        ...
        if file_transcriptions:
            status = "Pass"
            message = f"Exported JSON file contains Annotator transcription ('{TC_B_annotation_1_1}','{TC_B_annotation_1_Edit}','{TC_B_annotation_2_1}','{TC_B_annotation_2_Edit}') and Reviewer transcription ('{TC_B_reviewer_1_text_Approve}','{TC_B_reviewer_1_text_Edit}','{TC_B_reviewer_2_text_Approve}','{TC_B_reviewer_2_text_Edit}') for files {Dataset_files_upload}."
            ...
            status = "Fail"
            message = f"Exported JSON file validation failed. Annotator text in JSON: {TC_B_annotation_1_1 in file_transcriptions}, Reviewer text in JSON: {TC_B_reviewer_1_text_Approve in file_transcriptions}."
