...
def test_company_admin_C_flow_test(before_each):
    ...
    try: 
        ...
        annotator_1_email = test_data_inputs.get_annotator_1_email(action_factory.helpers)
        annotator_2_email = test_data_inputs.get_annotator_2_email(action_factory.helpers)
